...
export const botConfig = {
    ...
    activities: [
      {
        ...
        state: "Patroling",     // this is what people actually see
        type: 3,               // Custom
      },
    ],
  },
  ...
  commands: {
    ...
    // LEO-style text commands use a dot by default (e.g. .afk, .protect).
    // Set PREFIX in Railway if you ever want a different prefix.
